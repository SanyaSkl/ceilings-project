    ...
    return (
        <div className={s.ceilingViewsContainer}>
            <div className={s.ceilingViewTextContainer}>
                <h1 className={s.ceilingTypeHeader}>Парящие натяжные потолки</h1>
                <br/>
                ...
                <br/>
                <p className={s.descriptionText}>Парящие линии по периметру комнаты (Смонтированный с использованием
            ...
            <div>
                <div className={s.cardsWrap}>
                    <div className={s.card}>
                        <img className={s.cardImg} src={soarHall} alt={"soarHall"}/>
                    ...
                    <div className={s.card}>
                        <img className={s.cardImg} src={soarBedroom} alt={"soarBedroom"}/>
                    ...
                    <div className={s.card}>
                        <img className={s.cardImg} src={soarHallway} alt={"soarHallway"}/>
                    ...
                    <div className={s.card}>
                        <img className={s.cardImg} src={soarKitchen} alt={"soarKitchen"}/>
