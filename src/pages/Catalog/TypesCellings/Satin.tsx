    ...
    return (
        <div className={s.ceilingViewsContainer}>
            <div className={s.ceilingViewTextContainer}>
                <h1 className={s.ceilingTypeHeader}>Сатиновые натяжные потолки</h1>
                <br/>
                ...
                <br/>
                <p className={s.descriptionText}>Многие думают, что этот вид материала потолка выглядит как сатиновая ткань, но это не так.
            ...
            <div>
                <div className={s.cardsWrap}>
                    <div className={s.card}>
                        <img className={s.cardImg} src={satHall} alt={"satHall"}/>
                    ...
                    <div className={s.card}>
                        <img className={s.cardImg} src={satBedroom} alt={"satBedroom"}/>
                    ...
                    <div className={s.card}>
                        <img className={s.cardImg} src={satHallway} alt={"satHallway"}/>
                    ...
                    <div className={s.card}>
                        <img className={s.cardImg} src={satKitchen} alt={"satKitchen"}/>
